<div class="row">
    ...
    <div class="col-lg-6">
        ...
        <div class="card card-primary card-outline">
            ...
            <div class="card-body">
                <form name="depositForm" ng-submit="deposit(depositForm)" novalidate>
                    <div class="form-row">
                        ...
                        <div class="col-md-3 my-1">
                            <button type="submit" class="btn btn-success btn-disabled-not-allowed" ng-disabled="depositForm.$invalid || quantity < 1"><i class="fas fa-piggy-bank"></i><span> Deposit</span></button>
                        </div>
                    </div>
                </form>
            </div>
